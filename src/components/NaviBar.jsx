                ...
                <Navbar className="p-0" style={{ height: "4.5rem" }}>
                    ...
                    {!props.user && (
                        <Nav className="ml-auto">
                            <Link to="/signup" className="pr-2 link">
                                Create User
                            </Link>
                            <Link to="/login" className="pr-2 link">
                                Log In
                            </Link>
                        </Nav>
                    )}
                    ...
                    {props.user && (
                        <>
                            ...
                            <Nav className="ml-auto ml-md-0 pl-3">
                                <NavDropdown id="userNav" title={<img className="navbar-avatar" alt="" src={props.user.avatar} />} alignRight>
                                    <NavDropdown.Item as={Link} to={"/users/" + props.user._id}>
                                        Profile
                                    </NavDropdown.Item>
